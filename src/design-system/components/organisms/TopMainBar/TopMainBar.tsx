...
export default function TopMainBar({
  ...
  const selectedFarm = farmScopeNodes.find(
    (farm) => farm.facilityNodeId === selectedFacilityId,
  );
          ...
          {menuView === 'main' && (
            <Box>
              ...
              <MenuItem
                ...
                sx={{ color: 'error.main', py: 1.5, mb: 0.5 }}
              >
                <ListItemIcon>
